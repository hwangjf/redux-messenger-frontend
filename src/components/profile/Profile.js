    ...
    return (
      <React.Fragment>
        ...
        <div className="profile">
          ...
          {this.props.editProfile ? <div className="profile__edit" onClick={this.props.handleClickEditProfile}>done</div> : <div className="profile__edit" onClick={this.props.handleClickEditProfile}>edit</div>}
          <div className="profile__info">
            <div className="profile__header">name</div>
            {this.props.editProfile ? <input className="profile__input"></input> : <div className="profile__content">info</div>}
          </div>
          <div className="profile__info">
